...
<body>
    <div class="navbar_admin">
        ...
        <div>
            ...
            <a href="edit_activity.php">管理活動</a>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <?php if ($activity): ?>
                ...
                <form action="edit_activity.php?id=<?php echo $activity['activity_id']; ?>" method="post">
                    ...
                    <br>
                    <div class="input-group">
                        <input type="date" name="act_date" value="<?php echo htmlspecialchars($activity['act_date']); ?>"
                            required>
                    ...
                    <br>
                    <div class="input-group">
                        <input type="time" name="start_time" value="<?php echo htmlspecialchars($activity['STARTT']); ?>"
                            required>
                        <label>Start Time:</label>
                    </div>
                    <br>
                    <div class="input-group">
                        <input type="time" name="end_time" value="<?php echo htmlspecialchars($activity['ENDT']); ?>"
                            required>
